def tensor_name_v1():
    ...
    import os
    checkpoint_path = "/home/wangkai/Paper_MultiFeature_Data/vgg/vgg_19.ckpt"
...
def tensor_name_v2_new():
    ...
    chkp.print_tensors_in_checkpoint_file("/home/wangkai/logs_save/save/ppmiqa_with_downsample_on_syn_data/saved_3ckpt",tensor_name='', all_tensors=True)
